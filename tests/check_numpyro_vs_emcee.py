...
rs = np.array([0.12, -0.003, 0., 0.002, 0., 0., 0.002])
var_names = ['r0', 'r1', 'r2', 'r3', 'r4', 'r5', 'r6']
...
# plt.plot(ht.get_planet_transmission_string(theta))
# plt.show()
...
# start = time.time()
# state = sampler.run_mcmc(coords, 7000, progress=True)
# emcee_time = time.time() - start
# chain = sampler.get_chain(discard=3500, flat=True)
#
