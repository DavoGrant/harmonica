...
from numpyro.infer.reparam import LocScaleReparam, NeuTraReparam
...
def numpyro_model(t, obs_err, f_obs=None):
    ...
    # r1 = numpyro.sample('r1', dist.Normal(0., 0.01))
    # r2 = numpyro.sample('r2', dist.Normal(0., 0.01))
    ...
    # c0 = numpyro.sample('c0', dist.Uniform(0.05, 0.15))
    # c1 = numpyro.sample('c1', dist.Uniform(-0.01, 0.01))
    # c2 = numpyro.sample('c2', dist.Uniform(-0.01, 0.01))
    #
    # r0 = numpyro.deterministic('r0', c0)
    # r1 = numpyro.deterministic('r1', c1 - c2)
    # r2 = numpyro.deterministic('r2', c1 + c2)
