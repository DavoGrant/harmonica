...
void orbital_trajectories(double i, double j,
  ...
  // Compute star-planet separation, r.

  // Compute planet position, x, y, w (decide on symbol), relative to stellar centre in the plane of the sky.

  // update input arrays by pointers.
